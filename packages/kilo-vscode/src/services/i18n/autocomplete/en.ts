...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Klepa AI Autocomplete",
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Klepa AI Autocomplete (disabled)",
  ...
  "kilocode:autocomplete.toggleMessage": "Klepa AI Autocomplete {{status}}",
  "kilocode:autocomplete.progress.title": "Klepa AI",
  ...
  "kilocode:autocomplete.input.title": "Klepa AI: Quick Task",
  "kilocode:autocomplete.input.placeholder": "e.g., 'refactor this function to be more efficient'",
  "kilocode:autocomplete.commands.generateSuggestions": "Klepa AI: Generate Suggested Edits",
  ...
  "kilocode:autocomplete.commands.category": "Klepa AI",
  "kilocode:autocomplete.codeAction.title": "Klepa AI: Suggested Edits",
  "kilocode:autocomplete.chatParticipant.fullName": "Klepa AI Agent",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "The Klepa AI Autocomplete is being blocked by a conflict with GitHub Copilot. To fix this, you must disable Copilot's inline suggestions.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Klepa AI Autocomplete has been paused. Possible causes: your Klepa AI account has no remaining credits, or your configured API key (BYOK) has reached its quota limit. Add Klepa AI credits or check your API key configuration to resume autocomplete.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Add Credits",
  "kilocode:autocomplete.authError.message":
    "Klepa AI Autocomplete has been paused due to an authentication issue. Possible causes: you are not signed in to Klepa AI, or your API key (BYOK) is invalid or missing. Please sign in again or check your provider API key settings.",
}
