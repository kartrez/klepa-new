...
export const dict = {
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Klepa AI Autocomplete has been paused because your account has no remaining credits. Add credits to resume autocomplete.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Add Credits",
  "kilocode:autocomplete.authError.message":
    "Klepa AI Autocomplete has been paused due to an authentication error. Please sign in again.",
}
