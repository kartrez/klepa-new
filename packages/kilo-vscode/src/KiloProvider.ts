...
export class KiloProvider implements vscode.WebviewViewProvider, TelemetryPropertiesProvider {
  ...
  /**
   * Klepa does not show Kilo API promotional notifications in the webview.
   */
  ...
  private async handleResetAllSettings(): Promise<void> {
    const confirmed = await vscode.window.showWarningMessage(
      "Reset all Klepa AI extension settings to defaults?",
      { modal: true },
      "Reset",
    )
    ...
    vscode.window.showInformationMessage("Klepa AI settings have been reset to defaults.")
  }
