export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Install Anaconda Desktop on this machine, then return here. Klepa AI does not run the installer for you.",
  ...
  "provider.anaconda.state.signedOut": "Open Anaconda Desktop and sign in before connecting Klepa AI.",
  "provider.anaconda.state.unauthorized":
    "Klepa AI could not access Anaconda Desktop. Open Desktop, sign in again, and restart it if needed.",
  ...
  "provider.anaconda.state.ready":
    "Klepa AI found a healthy local text-generation server and can import its current connection settings.",
  ...
  "provider.anaconda.toast.refreshed.description": "The active local server and models are up to date in Klepa AI.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Klepa AI could not check the available skills.",
  "agentRequirements.error.mcpStatusFailed": "Klepa AI could not check MCP server status.",
  "agentRequirements.error.scopeMismatch": "This agent requirement check is no longer active.",
  "agentRequirements.error.requestFailed": "Klepa AI could not check the agent requirements.",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Klepa AI",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Klepa AI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Klepa AI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Klepa AI.",
  ...
  "speechToText.tooltip.start": "Start voice input with Klepa",
  ...
  "speechToText.error.loginRequired": "Sign in to Klepa AI to use speech input.",
  ...
  "dialog.server.description": "Switch which Klepa server this app connects to.",
  ...
  "toast.update.description": "A new version of Klepa AI ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Klepa AI team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Klepa AI does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Klepa AI includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for Klepa AI",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Klepa AI looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Klepa AI is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Klepa AI launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Klepa AI.",
  ...
  "settings.providers.betaNotice":
    "Currently only the Klepa provider can be configured in the settings interface. Support for configuring other providers is coming soon during the beta period. In the interim you can configure providers using the CLI or config file. We're committed to keeping Klepa AI open, no lock-in.",
  ...
  "settings.config.title": "Open {{scope}} Klepa config file",
  "settings.config.placeholder": "Config files are merged in order; files marked loaded currently affect settings.",
  "settings.config.noWorkspace": "Open a workspace folder to edit the local Klepa config file.",
  "settings.config.openFailed": "Failed to open {{scope}} Klepa config file: {{message}}",
  ...
  "workStyle.onboarding.welcome": "Welcome to Klepa AI",
  ...
  "workStyle.choice.human-in-the-loop.description": "Klepa AI pauses and shows you its plan as it works.",
  ...
  "deviceAuth.title": "Sign in to Klepa AI",
  ...
  "profile.action.login": "Login with Klepa AI",
  "gptChatBy.auth.title": "How do you want to get started?",
  "gptChatBy.auth.telegram.title": "Sign in with Telegram",
  "gptChatBy.auth.telegram.subtitle": "Sign in with Telegram",
  "gptChatBy.auth.apiKey.label": "gpt-chat.by API key",
  "gptChatBy.auth.apiKey.placeholder": "Enter API key...",
  "gptChatBy.auth.token.title": "Sign in with token",
  "gptChatBy.auth.token.subtitle": "Sign in with gpt-chat.by API key",
  "gptChatBy.auth.getToken": "Get token",
  ...
  "profile.pass.subscribe": "Get Klepa AI Pass to add credits and earn bonuses",
  ...
  "settings.indexing.kiloModel.title": "Klepa model preset",
  "settings.indexing.kiloModel.description": "Choose a supported Klepa-hosted embedding model.",
  "settings.indexing.kiloSignIn.title": "Klepa sign-in required",
  "settings.indexing.kiloSignIn.description": "Sign in to Klepa AI to use hosted embeddings.",
  ...
  "settings.aboutKiloCode.title": "About Klepa AI",

  "session.messages.empty": "Start a conversation by typing a message below.",
  "session.messages.welcome":
    "Klepa AI is an AI coding assistant. Ask it to build features, fix bugs, or explain your codebase.",
  ...
  "settings.aboutKiloCode.extensionName": "Klepa AI Extension",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "File does not contain valid Klepa AI settings.",
  "settings.aboutKiloCode.importSettings.tooLarge": "File is too large. Settings files must be under 1 MB.",
  "settings.aboutKiloCode.importSettings.newerVersion":
    "This file was exported from a newer version of Klepa AI. Some settings may be ignored.",
  ...
  "settings.experimental.speechToText.description":
    "Enable voice input in prompt fields using your Klepa account through Klepa.",
  ...
  "settings.experimental.remote.description":
    "Enable remote control of sessions via Klepa. This will also affect CLIs on this machine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Load CLAUDE.md instructions and skills from your Claude Code configuration directory into sessions. Enable this if you want Klepa AI to use your Claude Code instructions and skills. Requires restart.",
  ...
  "settings.display.fontSize.description": "Adjust the Klepa webview UI font size independently from VS Code.",
  ...
  "settings.models.hidePromptTraining.description":
    "Hide Klepa models whose providers may use your prompts for training.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migrate settings from a previous installation of Klepa AI, including provider API keys and default model.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "What's New in Klepa AI",
  ...
  "migration.whatsNew.features.foundation.detail":
    "One small, efficient core across every Klepa AI product. A familiar experience however you choose to work.",
  ...
  "diffViewer.source.session.tooltip":
    "Files changed by Klepa AI during the current session, based on per-turn snapshots. Resets when you start a new session.",
